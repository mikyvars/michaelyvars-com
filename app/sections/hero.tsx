...
const Hero = () => {
  return (
    <div className="flex flex-col items-center gap-12 px-4 py-16 md:flex-row-reverse md:justify-between md:px-20 md:py-24">
      <div className="flex">
      ...
      <div className="flex flex-col gap-12 md:w-1/2">
        <div className="flex flex-col gap-2">
          ...
          <Typography variant="body2">
            ...
            erat volutpat. Curabitur tempor quam ac iaculis viverra. Vestibulum
        ...
        <div className="flex flex-col gap-2">
          <div className="flex gap-2">
            ...
            <Typography variant="body2">Plaisance-du-Touch, France</Typography>
          </div>
          <div className="flex gap-2">
            <Icon variant="md">
